...
export class V1GazEmissionComponent implements OnInit {
	...
	refresh() {
		...
		this.v1GazEmissionForm.patchValue({ weightPrimaryMaterialCarbonneEmission: allVs.v1GazEmission.weightPrimaryMaterialCarbonneEmission })
		this.v1GazEmissionForm.patchValue({ primaryMaterialCarbonneEmission: allVs.v1GazEmission.primaryMaterialCarbonneEmission })
		this.v1GazEmissionForm.patchValue({ weightFirstMaterialCarbonneEmission: allVs.v1GazEmission.weightFirstMaterialCarbonneEmission })
		this.v1GazEmissionForm.patchValue({ firstMaterialCarbonneEmission: allVs.v1GazEmission.firstMaterialCarbonneEmission })
		this.v1GazEmissionForm.patchValue({ weightSecondMaterialCarbonneEmission: allVs.v1GazEmission.weightSecondMaterialCarbonneEmission })
		this.v1GazEmissionForm.patchValue({ secondMaterialCarbonneEmission: allVs.v1GazEmission.secondMaterialCarbonneEmission })
		this.v1GazEmissionForm.patchValue({ containsRareMaterial: allVs.v1GazEmission.containsRareMaterial })
		this.v1GazEmissionForm.patchValue({ totalElectrictyMix: allVs.v1GazEmission.totalElectrictyMix })
		this.v1GazEmissionForm.patchValue({ greenConsomation: allVs.v1GazEmission.greenConsomation })
		this.v1GazEmissionForm.patchValue({ greenProductionSite: allVs.v1GazEmission.greenProductionSite })
		this.v1GazEmissionForm.patchValue({ productionSiteFrench: allVs.v1GazEmission.productionSiteFrench })
		this.v1GazEmissionForm.patchValue({ transportCoef1: allVs.v1GazEmission.transportCoef1 })
		this.v1GazEmissionForm.patchValue({ distanceMode1: allVs.v1GazEmission.distanceMode1 })
		this.v1GazEmissionForm.patchValue({ transportCoef2: allVs.v1GazEmission.transportCoef2 })
		this.v1GazEmissionForm.patchValue({ distanceMode2: allVs.v1GazEmission.distanceMode2 })
		this.v1GazEmissionForm.patchValue({ fabricationMultisite: allVs.v1GazEmission.fabricationMultisite })
